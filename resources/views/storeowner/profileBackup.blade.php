            ...
            <div class="main-sec">
                ...
                <div class="container-profile">
                    @if($userId->image == null)
                        <img src="{{asset('assets/images/face.jpeg')}}" alt=""style="width:100px; height:150px; border:1px solid #ccc">
                        @else
                        <img src= "{{ $url }}" alt="" style="width:100px; height:100px; border:1px solid #ccc">
                        @endif
                ...
                <div class="container">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 edit_information">
                        <form action="{{ route('storeowner.update-profile') }}" method="POST" enctype="multipart/form-data" >
