...
<body>
    <header class="header">
        <a href={{route('cashier.cashier-dashboard')}} class="logo">Dazpay</a>
    ...
    <header class="container-1">
        <nav>
            <div class="nav-left">
                <a class="logo-text" href="{{ route('cashier.cashier-dashboard') }}"
    ...
    <div class="background-container">
        <section class="hero-sec">
            <div style="z-index: 100; top: -20px; position: absolute; left: -55px">
            ...
            <div class="main-sec" style="margin-top: 40px">
                <div id="personalInfo" class="container-personal">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 edit_information">
                        <form action="{{ route('cashier.update-profile') }}" method="POST"
                            ...
                            <div class="container-profile" style="margin-bottom: 10px">
                                ...
                                <label for="fileInput" class="file-upload-label">
                                    ...
                                    @else
                                        <img src="{{ url(asset('assets/'.$userId->image ))}}" class="profile-img-icon">
                ...
                <div id="security" class="Conatiner-2-passowrd" style="display: none;">
                    <form action="{{ route('cashier.update-password') }}" id="password-form" method="POST">
                        <input type="hidden" name="id" value="{{ $userId->id }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
