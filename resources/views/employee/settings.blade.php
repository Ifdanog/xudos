...
<body>
    ...
    <header class="container-1">
        <nav>
            <div class="nav-left">
                <a class="logo-text" href="{{route('dashboard')}}" style="text-decoration: none; color: white">Dazpay</a>
            </div>
            <div class="nav-right">
    ...
    <div class="background-container">
        <section class="hero-sec">
            <div style="z-index: 100; top: -20px; position: absolute; left: -130px">
            ...
            <div class="main-sec" style="margin-top: 40px">
                ...
                <div id="privateWallet" class="Conatiner-3-tetraportion" style="display: none;">
                    <form action={{ route('add-wallets') }} method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
